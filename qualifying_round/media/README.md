# Qualifying Round Media

예선 simulator 전체 주행 영상과 leaderboard 증빙을 보존했다. 영상은 브라우저 재생 호환성을 위해 H.264/yuv420p/BT.709로 변환하고 음성과 원본 메타데이터를 제거했다.
...
영상은 주행 과정을 보여 주는 정성 자료다. 녹화 길이를 공식 기록으로 재측정하거나 simulator 로그처럼 사용하지 않았다.
